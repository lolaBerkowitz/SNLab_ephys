...
% get_lfp: loads intan lfp data, resamples it, and gets a few extra theta features
% 
% Adapted from https://github.com/ryanharvey1/ephys_tools for SNLab_ephys
% by LB 08/11/2021
...
p = inputParser;
p.addParameter('Fold',30000); % raw sample rate
